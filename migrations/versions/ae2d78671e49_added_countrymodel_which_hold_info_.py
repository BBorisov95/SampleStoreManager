...
def upgrade():
    ...
    with op.batch_alter_table('orders', schema=None) as batch_op:
        batch_op.add_column(sa.Column('to_street_address', sa.String(length=255), nullable=False))
        batch_op.add_column(sa.Column('to_building_number', sa.Integer(), nullable=False))
        batch_op.add_column(sa.Column('payment_for_shipping', sa.Float(), nullable=False))
