...
def upgrade():
    ...
    with op.batch_alter_table('orders', schema=None) as batch_op:
        batch_op.add_column(sa.Column('delivery_type', sa.Enum('regular', 'fast', 'express', name='deliverytype'), nullable=False))
        batch_op.add_column(sa.Column('payment_status', sa.Enum('unpaid', 'paid', 'refunded', name='paymentstatus'), nullable=False))
